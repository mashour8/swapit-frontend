...
const PopUpAddSize = ({ handleAddNewSizeClick }) => {
    ...
    >
      ...
      >
        <div className="relative p-4 w-full max-w-xl max-h-full m-auto top-20 ">
          {/* Modal content */}
          <div className="relative bg-white rounded-lg shadow-xl shadow-gray-700">
            {/* Modal header */}

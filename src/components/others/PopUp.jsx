            ...
            <form className="p-4 md:p-5">
              <div className="grid gap-4 mb-4 grid-cols-2">
                ...
                <div className="upload col-span-2">
                  ...
                  <input
                    className="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 file:h-10"
                ...
                <div className="col-span-2 sm:col-span-1">
                  ...
                  <select
                    id="category"
                    value={selectedIsNew}
                    onChange={(e) => setSelectedIsNew(e.target.value)}
                    className="bg-gray-50 border border-gray-300
                          text-gray-900 text-sm rounded-lg
                          focus:ring-primary-500 focus:border-primary-500 block
                          w-full p-2.5 dark:bg-gray-600 dark:border-gray-500
                ...
                <div className="col-span-2 sm:col-span-1">
                  ...
                  <select
                    id="category"
                    value={selectedIsEssential}
                    onChange={(e) => setSelectedIsEssential(e.target.value)}
                    className="bg-gray-50 border border-gray-300
                          text-gray-900 text-sm rounded-lg
                          focus:ring-primary-500 focus:border-primary-500 block
                          w-full p-2.5 dark:bg-gray-600 dark:border-gray-500
                ...
                <div className="col-span-2 sm:col-span-1">
                  ...
                  <select
                    id="category"
                    value={selectedIsSeason}
                    onChange={(e) => setSelectedIsSeason(e.target.value)}
                    className="bg-gray-50 border border-gray-300
                          text-gray-900 text-sm rounded-lg
                          focus:ring-primary-500 focus:border-primary-500 block
                          w-full p-2.5 dark:bg-gray-600 dark:border-gray-500
